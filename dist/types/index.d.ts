...
export type GatewayMethod = 'connect' | 'health' | 'status' | 'send' | 'agent' | 'session.list' | 'session.get' | 'session.clear' | 'channel.list' | 'channel.status' | 'skill.list' | 'skill.invoke' | 'presence';
export type EventType = 'agent' | 'message' | 'presence' | 'tick' | 'shutdown' | 'channel.connected' | 'channel.disconnected' | 'session.updated';
